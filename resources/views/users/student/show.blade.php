    ...
    <div class="card card-profile shadow">
      ...
      <div class="card-body pt-0 pt-md-6">
        ...
        <div class="text-center">
          ...
          <div class="h5 mt-4">
            <i class="ni business_briefcase-24 mr-2"></i>Area - {{ isset($matter_student[1]->matter->career->area)?$matter_student[1]->matter->career->area->area:'None' }}
          </div>
          <div class="h5 mt-4">
            <i class="ni business_briefcase-24 mr-2"></i>Carrera - 
             {{ isset($matter_student[1]->matter->career->career)?$matter_student[1]->matter->career->career:'None' }}
          </div>
        </div>
      </div>
    </div>
